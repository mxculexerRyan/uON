...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3491589745ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=student&table=user">`student`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=uon&table=group_message">`uon`.`group_message`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=uon&table=group_member">`uon`.`group_member`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=uon&table=groups">`uon`.`groups`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=uon&table=messages">`uon`.`messages`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=uon&table=massages">`uon`.`massages`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=uon&table=users">`uon`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=school&table=details">`school`.`details`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=school&table=user">`school`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=servlet&table=user">`servlet`.`user`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4246723a4d6061645e3c4a24377c2953">
